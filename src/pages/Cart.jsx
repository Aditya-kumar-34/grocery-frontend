...
const Cart = () => {
  ...
  setCartArray([]); // Reset local state, too
};
  ...
  const placeOrder = (e) => {
    ...
    const amount = getCartAmount() + tax;
    ...
    if (paymentOption === "COD") {
      ...
      const options = {
        ...
        prefill: {
          name: "Lalith Kishore", // Optional: replace with user data
          email: "lalithkishore150@gmail.com",
          contact: "804826208",
        },
        notes: {
...
}, [products, cartItems]); // ✅ Listen to cartItems
